    ...
    public class RemoteVariablesUpdaterWindow : EditorWindow
    {
        ...
        private static void FetchData()
        {
            ...
            request.SendWebRequest().completed += _ =>
            {
                ...
                var remoteVariables =
                    JsonUtility.FromJson<Runtime.RemoteVariables.RemoteVariables>(request.downloadHandler.text);

                File.WriteAllText(Application.dataPath + "/Resources/RemoteData/RemoteVariables.json",
